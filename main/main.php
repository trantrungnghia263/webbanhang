...
<head>
    ...
    <title>ĐỒ GIA DỤNG - TRANG CHỦ</title>
</head>

<body>

    <?php include '../pageHeader/header.php' ?>
    <div id="wraper" style="margin-top: 20px; margin-bottom:-160px">
        <div class="drop_header">
            ...
            <form action="" method="GET">
                <div id="search">
                    <input type="text" id="search-item" name="search" id="search" placeholder="Tìm Kiếm Sản Phẩm">
                    <div id="search_icon">
        ...
        <div class="prev_product">
            <div class="left">
                ...
                <div class="info">
                    <div id="facebook">
                        <img src="images/me.JPG" alt="ảnh đại diện">
            ...
            <div class="camket_sp">
                <div class="text">
                    <div id="text1">
                        <span>
                            <marquee behavior="" direction="right">100% sản phẩm chính hãng</marquee>
                        </span>
                    </div>
                    <div id="text2">
                        <span>
                            <marquee behavior="" direction="" vspace="0.4%">Hỗ trợ đổi trả thoải mái</marquee>
                        </span>
                    </div>
                    <div id="text3">
                        <span>Uy Tín chất lượng
        ...
        font-family: 'Source Serif Pro', serif" class="products" id="productss">
            ...
            if (!empty($content)) {
                ...
                $sql = " select * from sanpham where maNhom < 3 limit $firtIndex,$limit";
        ...
        font-family: 'Source Serif Pro', serif" class="products" id="productss">
            ...
            if (!empty($content)) {
                ...
                $sql = " select * from sanpham where maNhom ='6' limit $firtIndex,$limit";
            $result = executeResult($sql, true);
            $sql1 = "select count(id) as 'total'  from sanpham";
            $kq = executeResult($sql1);
            $count = ($kq[0]['total']); // số lượng sản phẩm 
        ...
        <div class="product">
            ...
            <div class="product_bottom">
                ...
                <div class="product_price_2">
                    <p class="price_root_2">' . number_format($item['donGia']) . 'đ</p>
                </div>
            </div>
        </div>';
                }
        ...
        font-family: 'Source Serif Pro', serif" class="products" id="productss">
            ...
            if (!empty($content)) {
                ...
                $sql = " select * from sanpham where maNhom ='7' limit $firtIndex,$limit";
            $result = executeResult($sql, true);
            $sql1 = "select count(id) as 'total'  from sanpham";
            $kq = executeResult($sql1);
            $count = ($kq[0]['total']); // số lượng sản phẩm 
            ...
            if ($result != null) {
                foreach ($result as $item) {
                    $sale = ceil(100 - (($item['giaKhuyenMai']) / ($item['donGia']) * 100));   //tính % khuyến mãi
                    echo '  
        <div class="product">
            <div class="product_top">
             <img src="' . $item['hinhAnh'] . '"  width="350px" height=" auto" class="product_image" > 
    ...
    <hr width="87%" id="dongke">
    <div class="baivietlienquan">
        <div class="title">
            <p id="title">TỪ KHÓA LIÊN QUAN</p>
        </div>
        <div class="baiviet_left">
            <div id="one">
                <a href="#" target="_blank">Gia dụng nhà bếp</a>
            </div>
            <div id="two">
                <a href="#" target="_blank">Gia dụng chuyên dụng</a>
            </div>
            <div id="three">
                <a href="#" target="_blank">Gia dụng tiện nghi</a>
            </div>
        </div>
        <div class="baiviet_right">
            <div id="four">
                <a href="#" target="_blank">Sản phẩm nổi tiếng chất lượng</a>
            </div>
            <div id="five">
                <a href="#" target="_blank">Mua sắm đồ gia dụng online</a>
            </div>
            <div id="six">
                <a href="#" target="_blank">Một số sản phẩm gần gũi</a>
            </div>
        </div>
    </div>
    </div>

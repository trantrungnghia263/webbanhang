...
<?php  include '../pageHeader/header.php'?>
    ...
    <div class="marketing_title">
        <h3 style="text-align: center; margin-top:-120px;" >TẤT CẢ CÁC SẢN PHẨM </h3>
    </div>
    <div style="font-family: 'Abel', sans-serif;
        font-family: 'Dancing Script', cursive;
        font-family: 'Saira', sans-serif;
        font-family: 'Source Serif Pro', serif" class="products" id="productss">      <!--  phần này để show các sản phẩm -->
         <!-- sản phẩm thứ 1 -->
        <?php
        $limit=16;
        $page=1;

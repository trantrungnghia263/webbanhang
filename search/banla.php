...
<body>
    ...
    <div id="wraper" style="margin-top: 20px;">
        ...
        font-family: 'Source Serif Pro', serif">BÀN LÀ CẦM TAY</H3>
                <div style="font-family: 'Abel', sans-serif;
        font-family: 'Dancing Script', cursive;
        font-family: 'Saira', sans-serif;
        font-family: 'Source Serif Pro', serif; margin-top: 400px;" class="products" id="product_s">
        ...
        <div class="camket_sp">
            <div class="text">
                ...
                <div id="text3">
                    <span>
                        <marquee behavior="" direction="up"> Uy Tín chất lượng</marquee>
                    </span>
                </div>
            </div>
        </div>
